...
@Component({
  selector: 'app-razor-steel-fang-calculator-form',
...
export class CalculatorFormComponent implements OnInit, OnDestroy {
  ...
  setFormValue({ stats, talentLevel, hitCount, damageBonus, defense, resistance, critical }: CalculatorParams) {
    this.form.setValue(
      {
        skillDamage: {
          talentLevel,
