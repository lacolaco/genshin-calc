...
@Component({
  selector: 'app-xiao-plunging-attack-calculator-form',
...
export class CalculatorFormComponent implements OnInit, OnDestroy {
  ...
  readonly form = new FormGroup({
    ...
    burstTalentLevel: new FormControl<TalentLevel>(),
  ...
  ngOnInit() {
    this.form.valueChanges
      ...
      .subscribe(({ talentLevel, burstTalentLevel, characterStats, damageBonus, damageReduction }) => {
